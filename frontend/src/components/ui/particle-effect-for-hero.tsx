...
import { MousePointer2, Info, ArrowRight, Shield, Zap, Eye, Image, Brain, CheckCircle, TrendingUp } from 'lucide-react';
    ...
    return (
        <nav className="absolute top-0 left-0 w-full z-20 flex justify-between items-center p-6 md:p-8">
            <div className="flex items-center space-x-2">
                 ...
                 <span className="text-white font-medium tracking-wide text-lg">DeepTrust</span>
            </div>
        </nav>
    )
}
...
const HeroContent: React.FC<HeroContentProps> = ({ onStartClick }) => {
    return (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-4">
            <div className="max-w-4xl w-full text-center space-y-8">
                ...
                <p className="max-w-2xl mx-auto text-lg md:text-xl text-white/60 font-light leading-relaxed">
                    Advanced deepfake detection using EfficientNet and explainable AI. Analyze images and videos with state-of-the-art deep learning technology.
                </p>
...
export default function ParticleEffectForHero({ onStartClick, onAboutClick }: ParticleEffectForHeroProps) {
  return (
    <div className="relative w-full bg-black selection:bg-blue-500 selection:text-white">
      ...
      {/* Features Section */}
      <section className="relative py-32 px-4 bg-gradient-to-b from-black via-gray-900 to-black border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
              State-of-the-art deepfake detection powered by advanced AI technology
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group relative p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 animate-float" style={{animationDelay: '0s'}}>
              <div className="mb-6 w-14 h-14 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center">
                <Shield className="w-7 h-7 text-white/80" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">High Accuracy</h3>
              <p className="text-white/60 leading-relaxed">
                EfficientNet-based model trained on extensive datasets delivers up to 95%+ accuracy in detecting manipulated media.
              </p>
            </div>

            {/* Feature 2 */}
            <div className="group relative p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 animate-float" style={{animationDelay: '0.5s'}}>
              <div className="mb-6 w-14 h-14 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center">
                <Zap className="w-7 h-7 text-white/80" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Lightning Fast</h3>
              <p className="text-white/60 leading-relaxed">
                Optimized inference pipeline processes images in seconds and videos in minutes with GPU acceleration.
              </p>
            </div>

            {/* Feature 3 */}
            <div className="group relative p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 animate-float" style={{animationDelay: '1s'}}>
              <div className="mb-6 w-14 h-14 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center">
                <Eye className="w-7 h-7 text-white/80" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Explainable AI</h3>
              <p className="text-white/60 leading-relaxed">
                Grad-CAM visualization highlights suspicious regions, making the detection process transparent and trustworthy.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 px-4 bg-gradient-to-b from-black via-blue-950/20 to-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
              Three simple steps to detect deepfakes with AI precision
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            {/* Step 1 */}
            <div className="relative text-center animate-float" style={{animationDelay: '0s'}}>
              <div className="mx-auto mb-8 w-24 h-24 rounded-2xl bg-white/10 border-2 border-white/20 flex items-center justify-center shadow-2xl shadow-white/10 relative z-10">
                <Image className="w-12 h-12 text-white/80" />
              </div>
              <div className="absolute top-8 left-1/2 -translate-x-1/2 text-6xl font-bold text-white/5">01</div>
              <h3 className="text-2xl font-bold text-white mb-4">Upload Media</h3>
              <p className="text-white/60 leading-relaxed">
                Upload an image or video file that you want to analyze for potential deepfake manipulation.
              </p>
            </div>

            {/* Step 2 */}
            <div className="relative text-center animate-float" style={{animationDelay: '0.5s'}}>
              <div className="mx-auto mb-8 w-24 h-24 rounded-2xl bg-white/10 border-2 border-white/20 flex items-center justify-center shadow-2xl shadow-white/10 relative z-10">
                <Brain className="w-12 h-12 text-white/80" />
              </div>
              <div className="absolute top-8 left-1/2 -translate-x-1/2 text-6xl font-bold text-white/5">02</div>
              <h3 className="text-2xl font-bold text-white mb-4">AI Analysis</h3>
              <p className="text-white/60 leading-relaxed">
                Our EfficientNet model analyzes facial features, artifacts, and inconsistencies using deep learning.
              </p>
            </div>

            {/* Step 3 */}
            <div className="relative text-center animate-float" style={{animationDelay: '1s'}}>
              <div className="mx-auto mb-8 w-24 h-24 rounded-2xl bg-white/10 border-2 border-white/20 flex items-center justify-center shadow-2xl shadow-white/10 relative z-10">
                <CheckCircle className="w-12 h-12 text-white/80" />
              </div>
              <div className="absolute top-8 left-1/2 -translate-x-1/2 text-6xl font-bold text-white/5">03</div>
              <h3 className="text-2xl font-bold text-white mb-4">Get Results</h3>
              <p className="text-white/60 leading-relaxed">
                Receive detailed results with confidence scores, heatmaps, and frame-by-frame analysis for videos.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 px-4 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto">
            Start analyzing your media files now with our AI-powered detection system
          </p>
          <button 
            onClick={onStartClick}
            className="group relative inline-flex items-center gap-3 px-12 py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full text-lg font-bold tracking-wide overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50 active:scale-95"
          >
            <span className="relative z-10">Launch DeepTrust</span>
            <ArrowRight className="w-5 h-5 relative z-10 group-hover:translate-x-1 transition-transform" />
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500 ease-out"></div>
          </button>
        </div>
      </section>
      ...
      <footer className="relative py-12 px-4 bg-black border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-white/40 text-sm">
            © 2026 DeepTrust. AI-Powered Deepfake Detection Platform.
          </p>
        </div>
      </footer>
    </div>
